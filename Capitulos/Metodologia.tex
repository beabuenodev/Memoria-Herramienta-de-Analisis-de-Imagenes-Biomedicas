...
Se tratan de anotaciones geométricas representadas como contornos que aíslan la región de estudio, delimitando su extensión espacial. Estas selecciones se realizan para cada una de las \textit{slices} de la IRM, definiendo así la estructura anatómica de la característica de estudio.
...
Por último, tanto las máscaras de entrenamiento como las \textit{slices} de la IRM se orientan y se muestra una superposición para asegurar que el entrenamiento va a realizarse de manera correcta, alineando la máscara de entrenamiento con el órgano.
...
Debido al bajo número de datos anotados, habitual en el ámbito biomédico, usaremos además \textit{Transfer Learning}, una técnica de \textit{Deep Learning} usada para entrenar redes neuronales en base a otros modelos ya entrenados, para un caso de uso más concreto. Para esto, usaremos los pesos del modelo RadImageNet, un modelo entrenado en imágenes de IRM, TAC y Ecografía. 
...
\begin{figure}[H]
    ...
    el corte original de IRM, la máscara de referencia, la predicción del modelo
...
\citep{sundararajan2017axiomaticattributiondeepnetworks}. En el caso de las imágenes de IRM, la elección
...
superponen sobre el corte original de IRM, junto con la máscara de referencia y la
...
\begin{figure}[H]
    ...
    de izquierda a derecha, el corte original de IRM, la máscara de referencia,
