...
\begin{figure}[h]
    ...
    \includegraphics[width=0.64\textwidth]{Imagenes/Metodologia/outHerramienta.png}
    \hfill
    \includegraphics[width=0.3\textwidth]{Imagenes/Metodologia/Modelo3D.png}
...
Como ejemplo de salida del sistema, la Figura~\ref{fig:salida_herramienta} muestra tanto la visualización bidimensional de las máscaras obtenidas como la reconstrucción tridimensional del cerebro y la lesión isquémica devueltas por la herramienta tras analizar un caso de uso.
