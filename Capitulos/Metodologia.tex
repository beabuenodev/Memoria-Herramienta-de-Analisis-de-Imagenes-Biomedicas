...
\caption{Pipeline de procesamiento desde datos RAW hasta el dataset final. Fuente: elaboración propia.}
\end{figure}
...
\begin{figure}[h]
    ...
    \caption{Ejemplo de segmentación ROI. Fuente: elaboración propia.}
    \label{fig:img_roi}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Ejemplo de máscara binaria. Fuente: elaboración propia.}
...
\begin{figure}[h]
    ...
    \caption{Visualización de superposición entre la slice de resonancia magnética y su máscara de segmentación correspondiente. Fuente: elaboración propia.}
    \label{fig:img_mask}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Esquema de la arquitectura U-Net 2D empleada en este trabajo. Fuente: elaboración propia.}
...
\begin{figure}[htbp]
    ...
    \caption{Proceso de cálculo del volumen de la lesión a partir de la máscara segmentada. Fuente: elaboración propia.}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Imagenes/Metodologia/outHerramienta.png}
        \caption{Visualización en plano 2D de la segmentación obtenida.}
        \label{fig:out_herramienta_2d}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Imagenes/Metodologia/Modelo3D.png}
        \caption{Reconstrucción tridimensional del cerebro y la lesión isquémica.}
        \label{fig:modelo_3d}
    \end{subfigure}
    \caption{Ejemplo de salida generada por la herramienta, mostrando la segmentación en plano 2D y la reconstrucción 3D a escala real del cerebro y la región isquémica. Fuente: elaboración propia.}
    \label{fig:salida_herramienta}
\end{figure}

Como ejemplo de salida del sistema, la Figura~\ref{fig:salida_herramienta} muestra tanto la visualización bidimensional de las máscaras obtenidas como la reconstrucción tridimensional del cerebro y la lesión isquémica tras analizar un caso de uso.
