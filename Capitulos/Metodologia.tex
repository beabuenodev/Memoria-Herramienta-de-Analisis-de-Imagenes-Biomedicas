...
Para el análisis de explicabilidad se han seleccionado técnicas basadas en gradientes, por su facilidad de integración con modelos convolucionales. En concreto, se han implementado los métodos Grad-CAM(\cite{selvaraju2017gradcam}), Grad-CAM++(\cite{chattopadhyay2018gradcampp}) e Integrated Gradients. (\cite{sundararajan2017integrated})
