...
\subsection{Discusión crítica del sistema desarrollado}

Es importante destacar que el sistema desarrollado se concibe como una herramienta de apoyo supervisada, en la que el especialista mantiene el control sobre la interpretación final de los resultados. Los modelos de segmentación cerebral e isquémica generan máscaras automáticas y medidas volumétricas que pueden ser revisadas posteriormente, de forma que cualquier desviación respecto al criterio experto pueda identificarse y corregirse antes de utilizar los datos en un análisis definitivo.

Este enfoque resulta especialmente relevante en el contexto biomédico, donde la automatización no debe entenderse como una sustitución del especialista, sino como un mecanismo de asistencia para reducir el trabajo manual repetitivo y mejorar la eficiencia del proceso. Así, la herramienta se integra dentro de un flujo de trabajo asistido, en el que los resultados automáticos sirven como una primera aproximación cuantitativa y visual, pero requieren supervisión experta para su validación final.
