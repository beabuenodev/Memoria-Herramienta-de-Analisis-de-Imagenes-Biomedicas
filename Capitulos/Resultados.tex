...
\begin{figure}[h]
    ...
    \caption{Evolución del coeficiente Dice por Caso en el estudio de segmentación del cerebro en modelo control y con ictus isquémico permanente y transitorio.}
...
\begin{figure}[h]
    ...
    \caption{Comparación del volumen cerebral estimado por el modelo y el volumen obtenido a partir de la segmentación manual.}
...
\begin{figure}[h]
    ...
    \caption{Ejemplos cualitativos de segmentación del cerebro en distintos escenarios.}
...
\begin{figure}[h]
    ...
    \caption{Ejemplo cualitativo de explicabilidad aplicado al modelo de segmentación cerebral.}
...
\begin{figure}[h]
    ...
    \caption{Evolución del coeficiente Dice por Caso en el estudio de segmentación de lesión isquémica en modelo control y con ictus isquémico permanente y transitorio.}
...
\begin{figure}[h]
    ...
    \caption{Comparación del volumen de lesión isquémica estimado por el modelo y el volumen obtenido a partir de la segmentación manual.}
...
\begin{figure}[h]
    ...
    \caption{Ejemplo cualitativo de explicabilidad aplicado al modelo de segmentación de isquemia.}
...
\begin{figure}[h]
    ...
    \caption{Gráfico de Bland-Altman para analizar la concordancia entre el volumen calculado manualmente y el volumen estimado por el modelo.}
