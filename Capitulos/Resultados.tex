...
La Figura~\ref{fig:xai_cerebro_ejemplo_bueno} muestra un ejemplo representativo de un corte interior con buena segmentación cerebral. En ella se presenta la imagen original, la máscara de referencia, la máscara predicha, los mapas de relevancia generados mediante Grad-CAM, Grad-CAM++ e Integrated Gradients, y la curva de eliminación normalizada asociada.
