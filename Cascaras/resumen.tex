...
\noindent Imagen de Resonancia Magnética (IRM), Isquemia cerebral, Segmentación médica, región de interés (ROI), hipterintensidad, Inteligencia Artificial (IA), Redes Neuronales Convolucionales (CNN), U-Net, Inteligencia Artificial Explicable (XAI), Visión por computador
