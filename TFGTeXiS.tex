...
\ifpdf\hypersetup{%
    pdftitle = {\titulo},
    pdfsubject = {Herramineta de análisis de imágenes biomédicas},
    pdfkeywords = {Memoria, Trabajo de Fin de Grado, Inteligencia Artifical, imágenes biomédicas},
...
%
% Tikz estilo para diagramas de flujo
%
